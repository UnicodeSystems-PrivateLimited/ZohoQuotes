...
class Binder_request_model extends DataMapper {
    ...
    function SaveBinderToZoho($form_data, $file = '', $userData = array()) {
        ...
        $xmlData = $xmlData = '<CustomModule1>      
<row no="1">
<FL val="CustomModule1 Name"><![CDATA[' . $form_data['borrower_name'] . ']]></FL>
<FL val="CustomModule1 Email"><![CDATA[' . $form_data['borrower_email'] . ']]></FL>
<FL val="CustomModule1 Phone"><![CDATA[' . $form_data['borrower_phone'] . ']]></FL>
...
//    function SaveBinderNewToZoho($form_data, $file = '', $userData = array()) {
//        $ch = curl_init('https://crm.zoho.com/crm/private/xml/CustomModule1/insertRecords?');
//
//        curl_setopt($ch, CURLOPT_VERBOSE, 1); //standard i/o streams 
//
